...
def train(args, model_substruct, model_context, loader, optimizer_substruct, optimizer_context, device):
    ...
    for step, batch in enumerate(tqdm(loader, desc="Iterations")):
...
def main():
    ...
    parser.add_argument('--model_file', type=str, default = './MyModel/Contextpred50', help='filename to output the model')
