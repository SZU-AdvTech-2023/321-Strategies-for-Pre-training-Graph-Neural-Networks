...
def main():
    ...
    parser.add_argument('--input_model_file', type=str, default = './myModel/Contextpred50Mask', help='filename to read the model (if there is any)')
    parser.add_argument('--output_model_file', type = str, default = './myModel/Contextpred50MaskSup', help='filename to output the pre-trained model')
